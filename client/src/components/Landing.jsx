...
const LandingComponent = ({ resumeClick, resumeActive }) => (
  <section className="hero">
    ...
    <div className="head">
      <img className="headshot" src="https://javier-enriquez.000webhostapp.com/headshotCutout2.jpg" alt="Image" />
    </div>
    ...
    <div className="landing-buttons">
        ...
        <a onClick={()=> window.open('https://www.linkedin.com/in/javier-enriquez/', '_blank')} className="button is-large is-outlined b">
          <span>Linkedin</span>
          <span className="icon is-small">
